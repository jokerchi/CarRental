	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="取消日期" prop="quxiaoriqi">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.quxiaoriqi" label="取消日期" prop="quxiaoriqi">
					<el-input v-model="ruleForm.quxiaoriqi" placeholder="取消日期" readonly></el-input>
				</el-form-item>
