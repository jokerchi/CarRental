    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.xingming != '') searchWhere.xingming = '%' + this.formSearch.xingming + '%';
	      params['sfsh'] = '是';
        this.$http.get('haichexinxi/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/haichexinxiDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
