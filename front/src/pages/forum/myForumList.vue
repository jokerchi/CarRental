...
<div :style='{"border":"1px solid #dfdfdf","padding":"20px","margin":"20px auto 0","borderRadius":"16px","background":"#fff","width":"1200px","position":"relative"}'>
	...
	<div class="section-title" :style='{"margin":"0px 0","color":"#2087c3","borderRadius":"8px 8px 0 0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20221029/f414ce6eeb09429c9bc4d3d6643d9bd1.png) no-repeat center top","fontSize":"24px","lineHeight":"150px","fontWeight":"bold"}'>我的发布</div>
    <el-table
      :data="tableData"
      style="width: 100%">
      <el-table-column
...
<script>
  export default {
    ...
    methods: {
      ...
      getMyForumList(page) {
        this.$http.get('forum/list', {params: {page, limit: this.pageSize, parentId: 0, sort: 'add_time', order: 'desc'}}).then(res => {
          if (res.data.code == 0) {
